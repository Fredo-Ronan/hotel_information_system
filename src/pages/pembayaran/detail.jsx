...
export const DetailSection = () => (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            "url('https://cf.bstatic.com/xdata/images/hotel/max1024x768/386301950.jpg?k=afb811280ac0cb4a344bd1122c842b4b4edcfe53de644a967042b0ed1b6ee465&o=&hp=1')",
        }}
      >
                ...
                <div className="card mb-3 col-lg-12 h-10">
                  <div className="row">
                    <div className="col-6 p-3">
                      <img
                        src="https://www.konsultasi-akustik.com/wp-content/uploads/2021/02/interior-modern-comfortable-hotel-room-scaled.jpg"
                    ...
                    <div className="col-6 ml-auto mt-2">
                      <div className="card-body p-2">
                        <h1 className="card-title ml-auto fw-bold">
                          Luxury Hotel
                        </h1>
                        ...
                        <p className="card-text mb-0 mt-5">
                          Check in: Minggu, October 19, 2023
                        </p>
                        <p className="card-text mt-0">
                          Check out: Selasa, October 21, 2023
                        </p>
